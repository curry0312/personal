...
function About() {
  ...
  return (
    <section id="about" className="pt-20 px-16 bg-slate-50 lg:h-screen">
      <div className="flex flex-col md:flex-row h-full">
        ...
        <div className="flex flex-col gap-5 flex-1 p-10 md:p-16">
          <div>
            <h3 className="font-francois text-[20px] text-center md:text-[50px]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-2">
            ...
            <motion.div
              ...
              variants={listItem1}
              className="flex items-end min-h-[200px] bg-purple-100 transition-colors duration-200 ease-in-out group hover:bg-purple-600"
            >
